...
// Assignment 6
// trieTree
// trieTree.h is the header file for the trieTree class, it contains all function definitions for the class, as well as the class variables

#ifndef assignment_6_trieTree_h
#define assignment_6_trieTree_h
